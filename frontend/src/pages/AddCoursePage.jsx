      ...
      <form className="max-w-4xl mx-auto p-3" onSubmit={handleSubmit} >
        ...
        <div className="mb-5">
          ...
          >
            ...
            <AiOutlineCloudUpload onClick={handleUploadImg} className="text-3xl font-bold text-green-700 hover:cursor-pointer" />
...
{/* <ul className="max-w-md space-y-2 text-gray-500 list-inside dark:text-gray-400">
    ...
    <li className="flex items-center">
        ...
        {formData.thumbnail.length > 0 && formData.thumbnail.map((url) => (
            <div key={url}>
            <AiOutlineClose />
